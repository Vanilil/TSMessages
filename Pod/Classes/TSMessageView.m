...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = [UIColor hx_colorWithHexRGBAString:current[@"backgroundColor"]];
            [self addSubview:self.backgroundBlurView];
        }
        
        UIColor *fontColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"textColor"]];
        ...
        [self.titleLabel setShadowColor:[UIColor hx_colorWithHexRGBAString:[current valueForKey:@"shadowColor"]]];
        ...
        if ([subtitle length])
        {
            ...
            UIColor *contentTextColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"contentTextColor"]];
            if (!contentTextColor)
            {
        ...
        if ([buttonTitle length])
        {
            ...
            UIColor *buttonTitleShadowColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"buttonTitleShadowColor"]];
            ...
            UIColor *buttonTitleTextColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"buttonTitleTextColor"]];
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            self.borderView.backgroundColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"borderColor"]];
